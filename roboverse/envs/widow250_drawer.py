...
class Widow250DrawerEnv(Widow250Env):
    ...
    def _load_meshes(self):
        ...
        for object_name, object_position in zip(self.object_names, object_positions.repeat(len(self.object_names), axis=0)):
            if self.load_single and object_name != self.target_object:
                continue
