...
class Widow250PickPlaceEnv(Widow250Env):
    ...
    def _load_meshes(self):
        ...
        for object_name, object_position in zip(self.object_names, (self.original_object_positions * len(self.object_names) if self.load_mult else self.original_object_positions)):
            if self.load_mult and self.target_object != object_name:
                continue
    ...
    def get_info(self):
        ...
        for object_name in self.object_names:
            if self.load_mult and object_name not in self.objects:
                continue
